...
export const MAPS: GeoVisualItem[] = [
  ...
  },
  {
    ...
    keyTakeaway: 'High-suitability areas concentrated in North, North-East and South-East of the District with 41% of the land considered to be moderately to highly suitable for maize cultivation',
  ...
  },
  {
    ...
    keyTakeaway: 'Wetland degradation concentrated near urban centers, Bareland, agricultural zones and other areas facing high anthropogenic pressure. 31% of the wetland is poorly and very poorly healthy which highlights the need for targeted conservation and restoration efforts in these vulnerable areas',
