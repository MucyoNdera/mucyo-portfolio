      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div className="space-y-6">
            ...
            <p className="text-lg text-gray-900">
              I hold a Bachelor of Science (Honours) degree in Geography with a specialization in Environmental Planning from the University of Rwanda, 
              and my professional interests focus on sustainable natural resources management, climate adaptation, ecosystem restoration, and community empowerment.
            </p>
          </div>
