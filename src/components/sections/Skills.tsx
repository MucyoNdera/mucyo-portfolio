  ...
  return (
    <section id="skills" className="py-12 bg-white/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-bold text-green-900 mb-6">Skills & Technologies</h2>
        
        {/* Skills grid by category */}
        <div className="grid md:grid-cols-2 gap-6">
          {categories.map((category) => (
            <div key={category.label} className="space-y-1.5">
              <h3 className="text-xs font-semibold text-green-900 uppercase tracking-wider opacity-70">{category.label}</h3>
        ...
        {/* Proficiency legend */}
        <div className="mt-5 pt-3 border-t border-green-100">
          ...
          <div className="grid sm:grid-cols-3 gap-3">
            <div className="flex items-center gap-1.5">
              <div className="inline-block w-2.5 h-2.5 rounded-full bg-green-100 border border-green-300" />
              <span className="text-xs text-gray-700">Expert (75%+)</span>
            </div>
            <div className="flex items-center gap-1.5">
              <div className="inline-block w-2.5 h-2.5 rounded-full bg-emerald-100 border border-emerald-300" />
              <span className="text-xs text-gray-700">Advanced (60-74%)</span>
            </div>
            <div className="flex items-center gap-1.5">
              <div className="inline-block w-2.5 h-2.5 rounded-full bg-amber-100 border border-amber-300" />
